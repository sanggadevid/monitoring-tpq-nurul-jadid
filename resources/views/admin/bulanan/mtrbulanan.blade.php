                        ...
                        <div class="card">
                            ...
                            <div class="card-body">    
                                ...
                                <div class="table-responsive">
                                  ...
                                  <form action="/bulanan/store/{{$d->id}}" method="POST" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="Date" class="form-control" value="" name="mtrbulanan_tgl" required>
                                        </div>
                                        {{-- <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Nilai </label>
                                            <input type="number" class="form-control" value="" name="nilai_solat" required>
                                        </div>     
                                        <div class="form-group">
                                            <label>Pembelajaran Sholat (Keterangan/Catatan)</label>
                                            <textarea name="mtrbulanan_sholat"  class="form-control"></textarea>
                                        </div>
                                         {{-- Temp End --}}
                                          {{-- Temp Awal --}}
                                        ...
                                        <div class="form-group">
                                            <label>Nilai </label>
                                            <input type="number" class="form-control" value="" name="nilai_doa_harian" required>
                                        </div>     
                                        <div class="form-group">
                                            <label>Doa Harian (Keterangan/Catatan)</label>
                                            <textarea name="mtrbulanan_doa_harian"  class="form-control"></textarea>
                                        </div>
                                         {{-- Temp End --}}
                                              {{-- Temp Awal --}}
                                        ...
                                        <div class="form-group">
                                            <label>Nilai </label>
                                            <input type="number" class="form-control" value="" name="nilai_surah_pendek" required>
                                        </div>     
                                        <div class="form-group">
                                            <label>Hafalan Surah Pendek (Keterangan/Catatan)</label>
                                            <textarea name="mtrbulanan_surah_pendek"  class="form-control"></textarea>
                                        </div>
                                         {{-- Temp End --}}
                                                 {{-- Temp Awal --}}
                                        ...
                                        <div class="form-group">
                                            <label>Nilai </label>
                                            <input type="number" class="form-control" value="" name="nilai_quran" required>
                                        </div>     
                                        <div class="form-group">
                                            <label>Membaca Al-Quran (Keterangan/Catatan)</label>
                                            <textarea name="mtrbulanan_quran"  class="form-control"></textarea>
                                        </div>
                                         {{-- Temp End --}}
                                        <div class="form-group">
                                            ...
                                            <select  class="form-control" name="guru_id" required>
                                                {{-- <option value="" hidden>-- Silahkan Pilih -- </option>
                                                <option value="{{$d->guru_id}}" hidden>{{$d->guru_nama}}</option> --}}
